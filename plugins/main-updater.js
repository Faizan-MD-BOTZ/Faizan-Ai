...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://github.com/Faizan-MD-BOTZ/Faizan-Ai");
        ...
        await reply("🚀 Updating 𝐅𝐀𝐈𝐙𝐀𝐍-𝐀𝐈 𝐁𝐎𝐓...");

        // Download the latest code
        const zipPath = path.join(__dirname, "latest.zip");
        const { data: zipData } = await axios.get("https://github.com/Faizan-MD-BOTZ/Faizan-Ai", { responseType: "arraybuffer" });
