...
module.exports = {
    ...
    REPO: process.env.REPO || "https://github.com/Faizan-MD-BOTZ/Faizan-Ai/forkhttps://github.com/Faizan-MD-BOTZ/Faizan-Ai",  // Bot's GitHub repo
    ...
    DEVELOPER_NUMBER: '923408576674@s.whatsapp.net',            // Developer's WhatsApp ID
    ...
    STICKER_NAME: process.env.STICKER_NAME || "- _لا حاصل𓂃 ࣪ ִֶָ🥀⁸⁷³_",     // Sticker pack name
    AUTO_STICKER: process.env.AUTO_STICKER || "false",          // Auto-send stickers?
    // ===== MEDIA & AUTOMATION =====
    AUTO_RECORDING: process.env.AUTO_RECORDING || "false",      // Auto-record voice notes?
    AUTO_TYPING: process.env.AUTO_TYPING || "false",            // Show typing indicator?
    MENTION_REPLY: process.env.MENTION_REPLY || "false",   // reply on mentioned message 
    MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/ejufwa.jpg",  // Bot's "alive" menu mention image
    ...
    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝐅𝐀𝐈𝐙𝐀𝐍-𝐌𝐃 🤍*",  // Bot description
